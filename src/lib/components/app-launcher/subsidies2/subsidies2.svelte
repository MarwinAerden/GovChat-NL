                ...
                <div class="space-y-4">
                    ...
                    <div class="mt-3">
                        <button
                            ...
                            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-lg shadow-lg transition-all duration-200"                        >                            {#if isLoading && isLoadingSummary && isLoadingReport}
